 ...
 * ~/.codex/hooks.json, ~/.gemini/settings.json, ~/.gemini/config/hooks.json) so an uninstalled extension
...
import { uninstallHooks as uninstallAntigravityHooks } from '../../server/src/providers/hook/antigravity/antigravityHookInstaller.js';
...
Promise.allSettled(
  [uninstallClaudeHooks, uninstallCodexHooks, uninstallGeminiHooks, uninstallAntigravityHooks].map(
    (uninstall) =>
