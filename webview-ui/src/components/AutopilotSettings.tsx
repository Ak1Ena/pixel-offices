  ...
  return (
    ...
    >
      ...
      <span className="text-2xs text-text-muted">
        ...
        . A brief with no open questions and not high risk is built at once.
        ...
        Questions, risky plans, permissions and accepting results stay with you. Every agent spends
        tokens.
      </span>
      {state.canStartAgents && (
        <>
